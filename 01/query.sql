...
create table pedidos(
	id serial primary key,
    valor integer,
    cliente_cpf char(11) not null refrences clientes(cpf),
    vendedor_cpf char(11) not null refrences vendedores(cpf),
);
...
inset into produtos (nome, descricao, preco, quantidade_em_estoque, categorias_id)
values
...
insert into pedidos (valor , clientes_cpf , vendedor_cpf)
values
